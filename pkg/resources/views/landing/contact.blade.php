                ...
                <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
                    ...
                    <div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
                        <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                            ...
                            <h2 class="text-3xl font-bold tracking-tight text-white">Kontakt / Support</h2>
                            <p class="mt-6 text-lg leading-8 text-gray-300">Wir sind 24 Stunden am Tag für Sie erreichbar. In dringenden Fällen können Sie unsere Notfallhotline verwenden.</p>
                            <dl class="mt-10 space-y-4 text-base leading-7 text-gray-300">
                                <div class="flex gap-x-4">
                                    ...
                                    <dd>Bredow-IT<br>Rodheimerstraße 30<br>35398, Gießen<br>Hessen, Deutschland</dd>
                                </div>
                                <div class="flex gap-x-4">
                                    <dt class="flex-none">
                                    ...
                                    <dd><a class="hover:text-white" href="tel:+49 641 79799914">+49 641 79799914</a></dd>
                                </div>
                                ...
                                <div class="flex gap-x-4">
                                    ...
                                    <dd><a class="hover:text-white" href="mailto:info@bredow.systems">info@bredow.systems</a></dd>
                                </div>
                                ...
                                <div class="flex gap-x-4">
                                    ...
                                    <svg class="h-7 w-6 text-red-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m0-10.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.75c0 5.592 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.57-.598-3.75h-.152c-3.196 0-6.1-1.249-8.25-3.286zm0 13.036h.008v.008H12v-.008z" />
                                    </svg>

                                    <dt class="flex-none">
                                        <span class="sr-only">Notfallhotline</span>
                                        <span><a class="hover:text-red-700 text-red-400" href="tel:+49 641 79497532">Notfall,- Abuse-Hotline +49 641 79497532</a></span>
                                    </dt>
                    ...
                    <form action="#" method="POST" class="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48">
                        ...
                        <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
                            <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                                <div>
                                    <label for="first-name" class="block text-sm font-semibold leading-6 text-white">Vorname</label>
                                    <div class="mt-2.5">
                                ...
                                <div>
                                    <label for="last-name" class="block text-sm font-semibold leading-6 text-white">Nachname</label>
                                    <div class="mt-2.5">
                                ...
                                <div class="sm:col-span-2">
                                    <label for="phone-number" class="block text-sm font-semibold leading-6 text-white">Telefonnummer</label>
                                    <div class="mt-2.5">
                                ...
                                <div class="sm:col-span-2">
                                    <label for="message" class="block text-sm font-semibold leading-6 text-white">Ihre Nachricht</label>
                                    <div class="mt-2.5">
                            ...
                            <div class="mt-8 flex justify-end">
                                <button type="submit" onclick="Livewire.emit('openModal', 'contact-thanks')" class="rounded-md bg-indigo-500 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Senden</button>
                            </div>
